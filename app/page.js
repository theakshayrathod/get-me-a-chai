  ...
  return (
    <>
      <div className="flex justify-center flex-col text-white  gap-4 items-center h-[44vh]" >
        <div className="font-bold text-5xl flex gap-2 justify-center items-center " >Buy Me A Cofee <span><img className="w-16" src="/tea.svg" alt="" /></span> </div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 ">
        <h2 className="text-2xl font-bold text-center mb-14" >Your Followers can buy you Cofee</h2>
